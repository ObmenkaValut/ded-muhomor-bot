...
Если "ПОСЛЕДНЕЕ СООБЩЕНИЕ" — это просто короткое подтверждение или междометие («понятно», «понял», «ок», «ясно», «спс», «ага»), то отвечать не нужно, разговор окончен (возвращай "reply": false).
